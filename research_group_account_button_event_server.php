        ...
        function update_account($main_object,$value){
            ...
            if($result) {
                ...
                if($result) {
                    //echo "successful 2";
                    //delete 
                    $attribute = array("account","research_group"); 
                    $value = array("Student",$main_object->research_group);
                    ...
                    if($result){
                        ...
                        $sql = $query_make->insertion_query($query_make,"LogInTable",$attribute,$value);
                        $result = $main_object->exeute_query($main_object,$sql);
                        if($result) {
                            echo "successful";
                        }
