<?php
    ...
    class Make_Admin_Account{
        ...
        function make_page($main_object){
           ...
           $output .= '  <tr>
                            <td>Designation</td>
                            <td><select class="form-control"  id="t_designation">
                        ...
                        <tr>
                            ...
                            <td><select class="form-control" placeholder="Active/On leave" id="t_status">
           ...
           $output .= ' <!--Add supervisor -->
                        ...
                        </div>'; //End of simple form
           $output .= ' <!--Existing Teachers, previous design class="simple-form"--> ';
           $output .= '  <div style="margin-left:5%; margin-right:5%; class="simple-form"> ';
