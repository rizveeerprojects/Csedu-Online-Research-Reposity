...
$(document).ready(function() {
    ...
    function add_new_supervisor(teacher_name, teacher_email) {
        ...
        $.ajax({
            ...
            data: { operation: operation, variable: variable, value: value },
            success: function(data) {
                //debug: alert("adding a new teacher");
                //debug: alert(data);
                bring_research_group_supervisors();
            }
        });
    ...
    //to work onChane of select id view
    $(document).on('change', '#view', function() {
        var val = get_value_from_input('view');

        var path = "server_session_variable.php";
        var method = "POST";

        var operation = "update"; //make page
        var variable = "file_view";
        var value = val;
        ...
        $.ajax({
            ...
            success: function(data) {
                alert(data);
                if (data != "successful") {
                    alert("File view couldn't be update.");
                }
            }
        });
